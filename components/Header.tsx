...
import { changeTheme } from '../styles/handleTheme'
...
export const Header: React.FC = () => {
  ...
  return <div className="md:px-20 lg:px-40"
    ...
    <div className="navbar">
      <div className="navbar-start text-black text-black dark:text-white">
          ...
          <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-52 bg-white dark:bg-black">
            ...
            <li tabIndex={0}>
              ...
              <ul className="p-2 bg-white dark:bg-black">
                <li><a className="bg-white dark:bg-black">[BOOST]</a></li>
                <li><a className="bg-white dark:bg-black">[CRFA]</a></li>
              </ul>
            </li>
          </ul>
        </div>
        <a className="btn btn-ghost normal-case text-xl">Chain Expand</a>
      </div>
